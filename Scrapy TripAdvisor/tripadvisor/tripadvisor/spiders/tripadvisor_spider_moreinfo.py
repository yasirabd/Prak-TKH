...
#TODO use loaders
# untuk menjalankan, gunakan perintah : scrapy crawl tripadvisor_more -a start_url="http://some_url"
# contohnya, scrapy crawl tripadvisor_more -a start_url="https://www.tripadvisor.co.id/Hotels-g297712-Semarang_Central_Java_Java-Hotels.html" -o tripadvisor_semarang.csv
class TripadvisorSpiderMoreinfo(scrapy.Spider):
    ...
    def parse_review(self, response):
        ...
        item['title'] = response.xpath('//div[@class="quote"]/text()')[0].extract()[1:-1] # menghapus karakter pertama dan terakhir
